...
/// The styling contract for `SavedPaymentMethodView`.
///
/// Mirrors the platform-neutral three-group model defined in the styling doc
/// (`EditFiComponent(SavedPaymentMethodViewStyle) - Styling`): `root` (global type &
...
public struct SavedPaymentMethodViewStyle {
